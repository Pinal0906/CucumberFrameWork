...
public class OverviewPage extends BasePage{
    ...
    public void UserIsOnOverViewPage(){
        ...
        Assert.assertTrue(overviewPageInfo.isDisplayed(), "You are on Overview Page");
    }
    public void UserClicksOnFinishBtn(){
        finishBtn.click();
    }
    public void UserGetsSuccessMessage(){
        Assert.assertTrue(successMsg.isDisplayed(), "Your Order Successfully placed");
